...
- **核心信仰**：接口即契约，实现仅细节。
- **必读索引**：请始确认你已经阅读并记住了 `.ai/VIBE_CODING_GUIDE.md` 和 `docs/ARCHITECTURE.md` 的内容。

# 是否进行需要和用户/人类交互
如果对话中明确表明不需要你进行交互（如：完全由你完成，完全由ai完成，完全授权），则不需要用户评审。但这并不代表绕过评审，而是表明你应该扮演一个严格的审查员对自己的计划进行评审，并且提出修改意见，在这些意见被得到妥善解决之后，才能进行实际开发
